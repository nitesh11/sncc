 ...
 * for more information on this topic.ta
 */
function sncc_theme_alpha_process_region(&$vars) {
  if (in_array($vars['elements']['#region'], array('content', 'menu', 'branding1'))) {
